...
class NewHeatMap extends StatelessWidget {
  final DateTime startDate;
  final Map<DateTime, int> datasets;
  final Function(DateTime) onClick; // Callback function

  NewHeatMap({
    super.key,
    required this.startDate,
    required this.datasets,
    required this.onClick, // Initialize callback in constructor
  });
  ...
  Widget build(BuildContext context) {
    return HeatMapCalendar(
      ...
      datasets: datasets,
      onClick: (value) {
        onClick(value); // Pass the clicked date to the callback function
